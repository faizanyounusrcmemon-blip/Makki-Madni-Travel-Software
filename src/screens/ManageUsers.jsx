...
export default function ManageUsers({ onNavigate }) {
  ...
  const permissions = [
    ...
    // REPORTS
    "all_reports", "all_reports_today", "profit_report", "monthly_profit_dashboard", "sale_adjustment_report", "supplier_adjustment_only", "supplier_purchase_detail_report", "customer_sale_detail_report", "item_loss_zero_report", "sale_change_check_report", "gifting_report_view", "agent_comm_report_view", "upcoming_payment_due_report", "upcoming_travel_report",
